...
@get('/')
def index(request):
    summary1 = '测试博客，欢迎进入我的博客，目前是测试阶段，请耐心等待.'
    ...
    summary3 = 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.'
    blogs = [
        ...
        Blog(id='3', name='Learn Swift', summary=summary3, created_at=time.time()-7200)
    ]
